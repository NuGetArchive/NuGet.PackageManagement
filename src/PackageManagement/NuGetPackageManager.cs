...
namespace NuGet.PackageManagement
{
    ...
    public class NuGetPackageManager
    {
        ...
        //TODO: refactor all these overloads and put the arguments on the ResolutionContext
    ...
    private async Task<IEnumerable<NuGetProjectAction>> PreviewUpdatePackagesAsync(
            ...
            CancellationToken token)
        {
            ...
            else if (packageId != null)
            {
                ...
                // If we have been given just a package Id we certainly done want the one installed - pruning will be significant 
            ...
            else
            {
                ...
                // We are performing a global project-wdie update - nothing is prefered - again pruning will be significant
            ...
            try
            {
                ...
                var allSources = new HashSet<SourceRepository>(primarySources);
                ...
                nuGetProjectActions = GetProjectActionsForUpdate(newListOfInstalledPackages, oldListOfInstalledPackages, prunedAvailablePackages, nuGetProjectContext, force);
            }
            ...
            bool forceReinstall)
        {
            ...
            var newPackagesToUninstall = newListOfInstalledPackages;
            var newPackagesToInstall = oldListOfInstalledPackages;
